<?php /* Smarty version Smarty-3.1.16, created on 2015-09-16 11:44:02
         compiled from "/home/rpinterf/public_html/forum/sites/default/themes/default/templates/forum/category.tpl" */ ?>
<?php /*%%SmartyHeaderCode:147489546855f85b385130d2-79923952%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cdbd6c236d3127754677d5c244c4e480375bb58f' => 
    array (
      0 => '/home/rpinterf/public_html/forum/sites/default/themes/default/templates/forum/category.tpl',
      1 => 1442319386,
      2 => 'file',
    ),
    'd0fda9627028f9b1d690009a917fb5beaac5f438' => 
    array (
      0 => '/home/rpinterf/public_html/forum/sites/default/themes/default/templates/layout.tpl',
      1 => 1442398881,
      2 => 'file',
    ),
    '91b4fcff5dc996bf938a72b6f85ec45bbbcbd017' => 
    array (
      0 => '/home/rpinterf/public_html/forum/sites/default/themes/default/templates/forum/notification_level.tpl',
      1 => 1442319387,
      2 => 'file',
    ),
    '6dad206e74533a7ac8efbac21496144e343e7f76' => 
    array (
      0 => '/home/rpinterf/public_html/forum/sites/default/themes/default/templates/forum/editor.tpl',
      1 => 1442319386,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '147489546855f85b385130d2-79923952',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_55f85b38ca2be5_31201308',
  'variables' => 
  array (
    'sub_title' => 0,
    'site_title' => 0,
...
<?php if ($_valid && !is_callable('content_55f85b38ca2be5_31201308')) {function content_55f85b38ca2be5_31201308($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_get_opt')) include '/home/rpinterf/public_html/forum/sys/CODOF/Smarty/plugins/modifier.get_opt.php';
if (!is_callable('smarty_modifier_load_block')) include '/home/rpinterf/public_html/forum/sys/CODOF/Smarty/plugins/modifier.load_block.php';
if (!is_callable('smarty_modifier_get_preference')) include '/home/rpinterf/public_html/forum/sys/CODOF/Smarty/plugins/modifier.get_preference.php';
if (!is_callable('smarty_modifier_abbrev_no')) include '/home/rpinterf/public_html/forum/sys/CODOF/Smarty/plugins/modifier.abbrev_no.php';
if (!is_callable('smarty_function_get_children')) include '/home/rpinterf/public_html/forum/sys/CODOF/Smarty/plugins/function.get_children.php';
if (!is_callable('smarty_function_print_children')) include '/home/rpinterf/public_html/forum/sys/CODOF/Smarty/plugins/function.print_children.php';
?>
...
assets/img/general/favicon.ico?v=1">
        <link rel="apple-touch-icon" sizes="57x57" href="<?php echo @constant('DURI');?>
assets/img/general/apple-touch-icon-57x57.png">
        <link rel="apple-touch-icon" sizes="114x114" href="<?php echo @constant('DURI');?>
assets/img/general/apple-touch-icon-114x114.png">
        <link rel="apple-touch-icon" sizes="72x72" href="<?php echo @constant('DURI');?>
assets/img/general/apple-touch-icon-72x72.png">
        <link rel="apple-touch-icon" sizes="144x144" href="<?php echo @constant('DURI');?>
assets/img/general/apple-touch-icon-144x144.png">
        <link rel="apple-touch-icon" sizes="60x60" href="<?php echo @constant('DURI');?>
assets/img/general/apple-touch-icon-60x60.png">
        <link rel="apple-touch-icon" sizes="120x120" href="<?php echo @constant('DURI');?>
assets/img/general/apple-touch-icon-120x120.png">
        <link rel="apple-touch-icon" sizes="76x76" href="<?php echo @constant('DURI');?>
assets/img/general/apple-touch-icon-76x76.png">
        <link rel="apple-touch-icon" sizes="152x152" href="<?php echo @constant('DURI');?>
assets/img/general/apple-touch-icon-152x152.png">
        <link rel="icon" type="image/png" href="<?php echo @constant('DURI');?>
assets/img/general/favicon-196x196.png" sizes="196x196">
        <link rel="icon" type="image/png" href="<?php echo @constant('DURI');?>
assets/img/general/favicon-160x160.png" sizes="160x160">
        <link rel="icon" type="image/png" href="<?php echo @constant('DURI');?>
assets/img/general/favicon-96x96.png" sizes="96x96">
        <link rel="icon" type="image/png" href="<?php echo @constant('DURI');?>
assets/img/general/favicon-16x16.png" sizes="16x16">
        <link rel="icon" type="image/png" href="<?php echo @constant('DURI');?>
assets/img/general/favicon-32x32.png" sizes="32x32">
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('forum/notification_level.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '147489546855f85b385130d2-79923952');
content_55f947f27f8128_10210479($_smarty_tpl);
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('forum/editor.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '147489546855f85b385130d2-79923952');
content_55f947f298a4a9_57198780($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); 
...
<?php }} ?>
<?php /* Smarty version Smarty-3.1.16, created on 2015-09-16 11:44:02
         compiled from "/home/rpinterf/public_html/forum/sites/default/themes/default/templates/forum/notification_level.tpl" */ ?>
<?php if ($_valid && !is_callable('content_55f947f27f8128_10210479')) {function content_55f947f27f8128_10210479($_smarty_tpl) {?>
...
<?php }} ?>
<?php /* Smarty version Smarty-3.1.16, created on 2015-09-16 11:44:02
         compiled from "/home/rpinterf/public_html/forum/sites/default/themes/default/templates/forum/editor.tpl" */ ?>
<?php if ($_valid && !is_callable('content_55f947f298a4a9_57198780')) {function content_55f947f298a4a9_57198780($_smarty_tpl) {?>
